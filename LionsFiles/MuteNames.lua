...
if DevAbs:get(Lions.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Lions.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Lions.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Lions.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Lions.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Lions.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
LionsName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if LionsName then 
LionsNames = DevAbs:smembers(Lions.."Abs:Mute:Names"..msg.chat_id_) or ""
if LionsNames and LionsNames[1] then 
for i=1,#LionsNames do 
if LionsName:match("(.*)("..LionsNames[i]..")(.*)") then 
...
DevAbs:set(Lions.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Lions.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
